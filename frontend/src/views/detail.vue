          ...
          <div class="ml-3 flex-1 overflow-auto">
            <div class="mb-[5px]">
              <div>
                <div class="flex items-center"> 
                  ...
                  <a href="#" class="text-[14px] text-[#61666D] shrink-0">
                    <i class="icon-email iconfont" style="font-size: 14px; color: #61666D"></i>
                    发消息
                  </a>
                </div>
            ...
            <div>
              <div class="flex mt-[5px] whitespace-nowrap clear-both">
                <div class="bg-transparent border border-solid border-theme-color mr-3 shrink-0 w-[109px] text-theme-color box-border p-0 leading-[30px] h-[30px] rounded-md text-[14px] flex items-center justify-center cursor-pointer relative">
                  <div class="w-5 h-5 mr-1 flex">
                    <img src="../assets/lightning.png" class="w-full h-full align-middle border-none" />
                  </div>
                  <span>充电</span>
                </div>
                <div class="bg-theme-color text-white max-w-[230px] flex-auto box-border p-0 leading-[30px] h-[30px] rounded-md text-[14px] flex items-center justify-center cursor-pointer relative">
